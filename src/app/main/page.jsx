...
import { FaImage, FaMicrophone, FaUserCircle } from "react-icons/fa";
...
const debouncedDetectLanguage = useCallback(
  debounce(async (text) => {
    ...
    try {
      ...
      console.error("Error during debounced language detection:", error);
...
const handleInputChange = (e) => {
  ...
  setInputText(text);
  // Use the debounced version rather than calling detectLanguage immediately
